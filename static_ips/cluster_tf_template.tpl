...
THIS FILE IS AUTOMATICALLY GENERATED BY THE static_ips DIRECTORY AND SHOULD NOT MANUALLY BE ALTERED AS CHANGES COULD BE DELETED IF AN APPLY
IS RUN FROM INSIDE THE static_ips DIRECTORY
...
however once the ability exists to make multiple copies this code will be refactored and removed!
